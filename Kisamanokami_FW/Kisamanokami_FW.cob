...
<Project>
  ...
  <ExcludedFiles>
    <Exclude path="C:\CooCox\CoIDE\workspace\Kisamanokami_FW\example\TIM_PWMOutput.c"/>
    <Exclude path="C:\CooCox\CoIDE\workspace\Kisamanokami_FW\example\GPIO_Blink.c"/>
    <Exclude path="C:\CooCox\CoIDE\workspace\Kisamanokami_FW\example\usart_rxtx.c"/>
    <Exclude path="C:\CooCox\CoIDE\workspace\Kisamanokami_FW\example\ADC_Exp.c"/>
    <Exclude path="C:\CooCox\CoIDE\workspace\Kisamanokami_FW\example\PrintChar.c"/>
  </ExcludedFiles>
</Project>
